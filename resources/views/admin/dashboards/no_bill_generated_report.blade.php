...
@section('title','Total No Bill Generated Report')
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Total No Bill Generated/Customer Visit- Report</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
...
<section class="content">
    <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group bg-warning text-center p-2">
                                    <label>Over All Total No Bill Generated Report</label>
                                    <br>
      ...
      <div class="col-md-12">
        <h3 class="text-center">Bill Generated Of Current Month According To Date Wise</h3>
          <div class="col-md-12 col-md-offset-2">
            <div class="col-xl-12">
              <div class="card">
                <div class="card-body">
                  <div class="card-body">
                    <h4> Bill Generated Day Wise  </h4>
                    <div class="d-flex">
         ...
         <div class="col-md-12">
            <h3 class="text-center"> Bill Generated Of Current Year According To Month Wise</h3>
              <div class="col-md-12 col-md-offset-2">
                <div class="col-xl-12">
                  <div class="card">
                    <div class="card-body">
                      <div class="card-body">
                        <h4> Bill Generated Month Wise  </h4>
                        <div class="d-flex">
         ...
         <div class="col-md-12">
            <h3 class="text-center"> Bill Generated Of  Year According To Year Wise</h3>
              <div class="col-md-12 col-md-offset-2">
                <div class="col-xl-12">
                  <div class="card">
                    <div class="card-body">
                      <div class="card-body">
                        <h4> Bill Generated Year Wise  </h4>
                        <div class="d-flex">
