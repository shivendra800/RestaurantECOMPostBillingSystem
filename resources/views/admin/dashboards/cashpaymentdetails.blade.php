...
@section('title','Cash Payment Details')
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Cash Payment Details</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group bg-warning text-center p-2">
                                    <label>Over All Total Cash</label>
                                    <br>
              ...
              <div class="col-md-12 col-md-offset-2">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Cash Payment Details</h3>
