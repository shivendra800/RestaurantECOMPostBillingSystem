...
@section('title','Overall Online Order List')
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Overall Online Order List</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          ...
          <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            <label>Over All Online Order Collection</label>
                            <input class="form-control" value="Rs.{{ $overallcollectionwithGSt }}" readonly="">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
              <div class="card">
                  <div class="card-body">
                      <div class="form-group">
                          <label>Over All Online Order  Tax Collection</label>
                          <input class="form-control" value="Rs.{{ round($overallcollectionwithoutGSt,2) }} " readonly="">
                      </div>
                  </div>
              </div>
          </div>
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Overall Online Order  List</h3>
