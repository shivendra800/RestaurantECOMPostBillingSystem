...
<section class="content">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                   ...
                                   <li><a class="btn btn-info" href="{{ url('admin/view-table-orderitem/'.$tablebook['group_item']) }}">View Order</a></li> 
                                @if($tablebook['order_item_status']=="New-Order")
                                {{-- <audio controls autoplay>
                                 
                                  <source src="{{url('/')}}/admin_assets/new-order-place-plz-accept-order-you-just-received-a-text-message.mp3" type="audio/mpeg">
                                ...
                                {{-- <audio id="myAudio" autoplay>
                                  ...
                                  <source src="{{url('/')}}/admin_assets/new-order-place-plz-accept-order-you-just-received-a-text-message.mp3" type="audio/mpeg">
                                    ...
                                    action="{{ url('/') }}/admin/accept-orderKich-status">
                                    {{ csrf_field() }}
 ...
 <li><a class="btn btn-warning" target="_blank" href="{{ url('admin/print-kot-summary/'.$tablebook['group_item']) }}">Print KOT</a></li> 
                            @else
                            <li><a class="btn btn-warning" target="_blank" href="{{ url('admin/print-kot-summary/'.$tablebook['group_item']) }}">Print KOT</a></li> 
                            @endif
