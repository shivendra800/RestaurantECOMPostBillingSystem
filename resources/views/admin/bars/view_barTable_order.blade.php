            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <a style="max-width: 150px; float:right; display:inline-block;" href="{{ url('admin/take-tableWiseOrder') }}" class="btn btn-block btn-info">Back</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" action="{{ url('admin/bar-tableTransfer-order/'.$orderlist['order_no']) }}" class="forms-sample">
                                    @csrf
                                <div class="form-group">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <br>
                    ...
                    <form method="post" action="{{ url('admin/add-barTable-more-item/'.$orderlist['order_no']) }}" class="forms-sample">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                    ...
                    <tbody>
                        ...
                        @endphp
                             ...
                             <tr>
                                ...
                                <td >{{ $item['item_qty'] + $item['no_qty_buy_to_free'] }}</td>
                                <td>{{ $item['item_qty'] }}</td>

                                <td >
                                    @if(!empty($item['no_of_qty_buy']))
                                   <strong class="badge badge-info">{{ $item['no_qty_buy_to_free'] }}  </strong> 
                                    @else
