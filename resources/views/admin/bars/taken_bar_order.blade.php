            ...
            <div class="col-md-3">
              ...
              <div class="card card-success">
                ...
                <div class="card-body">
                  ...
                  <strong>Booking Status:-</strong><a href="{{ url('admin/bar-table-order/'.$bartable['id']) }}"><button class="btn btn-warning">Bar Table is Not Book Yet!Click Here</button></a>
                  @else
                  <strong>Booking Status:-</strong><a href="{{ url('admin/bar-table-order-view/'.$bartable['order_no']) }}"><button class="btn btn-danger">Bar Table <strong class="btn btn-warning">({{ $bartable['order_no'] }})</strong> Is Already Booked!</button></a>
                  @endif
                </div>
                <!-- /.card-body -->
              </div>
