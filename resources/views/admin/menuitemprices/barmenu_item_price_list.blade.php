      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Bar Menu Item List</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title ">
                       <a href="{{url('/')}}/admin/add-edit-barMenuItemPrice"> <button type="button" class="btn btn-block btn-info btn-flat ">Create Bar Menu Item Price</button></a>
                    </h3>
                </div>
             </div>
          <!-- /.card -->
                    ...
                    @foreach ($menuitemPrice as $index=>$menuitemPrice)
                        ...
                        <td>
                            ...
                            <div style="display:inline-flex;">
                                ...
                                @if ($menuitemPrice['status'] == '1')
                                     <form method="post" id="inactive_form_{{ $menuitemPrice['id'] }}"
                                         action="{{ url('/') }}/admin/Change-barMenuItemPrice-status">
                                         {{ csrf_field() }}
                            ...
                            <td>
                                ...
                                <a title="Edit type Details" href="{{ url('admin/add-edit-barMenuItemPrice/'.$menuitemPrice['id'] ) }}"><i style="font-size:25px;" class="fa fa-edit"></i></a>
                                <form method="post" id="delete_form_{{ $menuitemPrice['id'] }}"
                                action="{{ url('/') }}/admin/Delete-barMenuItemPrice/{{ $menuitemPrice['id'] }}">
                                {{ csrf_field() }}
