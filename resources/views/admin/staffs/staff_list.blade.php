        ...
        <div class="col-12">
            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title ">
                       <a href="{{url('/')}}/admin/add-edit-staffs"> <button type="button" class="btn btn-block btn-info btn-flat ">Create Staff & Role </button></a>
                    </h3>
                </div>
             </div>
          <!-- /.card -->
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="  table table-bordered table-hover dataTable dtr-inline"
                ...
                <button style="margin-bottom: 10px" class="btn btn-primary delete_all" data-url="{{ url('admin/staffsDeleteAll') }}">Delete All Selected</button>
                <thead>
                <tr>
                ...
                <tbody>
                    @foreach ($staffList as $index=>$type)
                        <tr id="tr_{{$type['id']}}">
                          ...
                          <div style="display:inline-flex;">
                            ...
                            @if ($type['status'] == '1')
                                 <form method="post" id="inactive_form_{{ $type['id'] }}"
                                     action="{{ url('/') }}/admin/Change-menu-staff-status">
                                     {{ csrf_field() }}
                            ...
                            <td>
                              <div style="display:inline-flex;">
                                ...
                                <a title="Edit type Details" href="{{ url('admin/add-edit-staffs/'.$type['id'] ) }}"><i style="font-size:25px;" class="fa fa-edit"></i></a>
                                <form method="post" id="delete_form_{{ $type['id'] }}"
                                action="{{ url('/') }}/admin/Delete-staffs/{{ $type['id'] }}">
                                {{ csrf_field() }}
                                ...
                                <span onclick="deleteRow('{{ $type['id']  }}')" type="button"
                                    ...
                                    <a title="Update Staff Wise Password" href="{{ url('admin/updatestaffWise-password/'.$type['id'] ) }}"><span class="btn btn-warning"><i  class="fa fa-lock-open"></i></span></a><br>
                              </div>
                            </form>
                            </td>
