        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Copuon On Price</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h3 class="card-title ">
                            <a href="{{url('/')}}/admin/add-edit-Coupon-On-price"> <button type="button" class="btn btn-block btn-info btn-flat ">Create Coupon-On-price</button></a>
                        </h3>
                    </div>
                </div>
                <!-- /.card -->
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Coupon-On-Price</h3>
                        ...
                        <table id="example1" class="  table table-bordered table-hover dataTable dtr-inline" aria-describedby="example1_info">
                            ...
                            <tbody>
                                @foreach ($coupononprice as $index=>$itemcoupon)
                                    ...
                                    <td>{{ $itemcoupon['order_amount'] }}</td>
                                    <td>{{ $itemcoupon['remark'] }}</td>
                                    ...
                                    <td>{{ $itemcoupon['expiry_date'] }}</td>
                                        ...
                                        <td>
                                          <div style="display:inline-flex;">
                                            ...
                                            <a title="Edit type Details" href="{{ url('admin/add-edit-Coupon-On-price/'.$itemcoupon['id'] ) }}"><i style="font-size:25px;" class="fa fa-edit"></i></a>&nbsp;&nbsp;
                                            <form method="post" id="delete_form_{{ $itemcoupon['id'] }}"
                                            action="{{ url('/') }}/admin/Delete-CouponOnprice/{{ $itemcoupon['id'] }}">
                                            {{ csrf_field() }}
