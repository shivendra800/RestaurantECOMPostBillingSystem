...
@section('title', 'Bar Order Checkout')
...
<section class="content-header">
    <div class="container-fluid" id="mycontent">
        <div class="row">
            <div class="col-sm-6">
                <h1>Bar Order Checkout</h1>
            </div>
            <div class="col-sm-6 d-none d-sm-block">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Bar Checkout </li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title"> Bar Checkout</h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"> Bar  Purchase Order Details</h4><br>
                                <div class="form-group">
                                    <label>Order No</label>
                                    <input class="form-control" value="{{ $getbarTableOrder['order_no'] }}" readonly="">
                                </div>
                                
                                <div class="form-group">
                                    <label>Sub Total</label>
                                    <input class="form-control" value="Rs.{{ $getbarTableOrder['sub_total'] }}" readonly="">
                                </div>
                                @if(!empty($getbarTableOrder['coupon_per']))
                                <div class="form-group">
                                    <label>Coupon Apply</label>
                                    <input class="form-control" value="{{ $getbarTableOrder['coupon_per'] }}% Off" readonly="">
                                </div>
                                @endif
                                @if(!empty($getbarTableOrder['subtotalwithoffer']))
                                <div class="form-group">
                                    <label>New Sub Total</label>
                                    <input class="form-control" value="Rs.{{ $getbarTableOrder['subtotalwithoffer'] }}" readonly="">
                                </div>
                                @endif
                                <div class="form-group">
                                    <label>Total Tax</label>
                                    <input class="form-control" value="Rs.{{ $getbarTableOrder['total_tax'] }}" readonly="">
                                </div>
                                <div class="form-group">
                                    <label>Grand Total</label>
                                    <input class="form-control" value="Rs.{{ $getbarTableOrder['grand_total'] }}" readonly="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Bar  Purchase Order Item List</h4><br>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    @foreach ($getbarTableOrderItem as $index => $orderitem )
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="{{ url('admin/complete-barTableCheckoutOrder/'.$getbarTableOrder['order_no']) }}">

                        @csrf

                        <input type="hidden" name="orderid" class="order_id" value="{{ $getbarTableOrder['order_no'] }}">
                        @php
                            $grandtotal = $getbarTableOrder['grand_total'];
