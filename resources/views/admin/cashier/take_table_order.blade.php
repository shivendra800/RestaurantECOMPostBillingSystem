            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ url('admin/take-table-order/'.$gettableselect['id']) }}" class="forms-sample">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <select name="staff_id" required="" class="form-control">
                                                            ...
                                                            @foreach($getstaff as $staffName)
                                                            <option value="{{ $staffName->staff_id }}">{{ $staffName->name }}--{{ $staffName->type }}</option>
    ...
    function getExtraMenuPrice(ele) {
       ...
       // alert(extra_menu_item_id);
        $.ajax({
            ...
            , success: function(data) {
                  console.log("data", data);
                 console.log("hhghg", data.data[0].price);
