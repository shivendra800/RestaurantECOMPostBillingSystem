                        ...
                        <div class="row input-fields product_data">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control v_tye_wise_id @error('v_wise_type_id') is-invalid @enderror" name="v_tye_wise_id" id="v_tye_wise_id" onchange="getPreAmt();" required>
                            ...
                            <div class="row" id="openwithpayment">
                                ...
                                <div class="col md-4">
                                    <div class="form-group">
                                        ...
                                        @enderror
                                        @else
                                        <input type="text" class="form-control previous_amount @error('previous_amount') is-invalid @enderror" name="previous_amount" id="previous_amount" value="" placeholder="Enter Your previous_amount" readonly="">
                                        @endif
                                    </div>
                                </div>
                                <div class="col md-4">
                                ...
                                <div class="col md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.001" min="0" class="form-control paid_amount @error('paid_amount') is-invalid @enderror" onkeyup="paymentUpdate()" name="paid_amount" id="paid_amount" placeholder="Enter Your paid_amount" >
                                        @error('paid_amount')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
...
<script id="document-template" type="text/x-handlebars-template">
    ...
    <td>
        <input type="text" required step="0.001" min="0" class="form-control weight @error('weight') is-invalid @enderror" name="weight[]" id="weight"  placeholder="Enter Your weight" onkeyup="CalculateTotal(this)" >
        @error('weight')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </td>
