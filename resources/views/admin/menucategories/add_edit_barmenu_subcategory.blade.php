      ...
      <div class="row">
        ...
        <div class="col-md-12">
                ...
                <div class="card card-primary">
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form class="forms-sample" @if(empty($menSubcategory['id'])) action="{{ url('admin/add-edit-barmenu-subcategory') }}"
                            @else action="{{ url('admin/add-edit-barmenu-subcategory/'.$menSubcategory['id']) }}"   @endif
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="{{url('/')}}/admin/bar-menu-subcategory" class="btn btn-secondary">Back</a>
                                  </div>
