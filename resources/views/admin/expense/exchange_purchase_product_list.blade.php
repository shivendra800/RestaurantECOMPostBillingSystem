...
@section('title','Vendor Wise Product Return')
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="{{ url('admin/exchange-ExternalpurchasePrdouct/'.$getvendor['id']) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                        <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Select Product Type</label>
                                          <select class="form-control select2 @error('return_product_id') is-invalid @enderror"  name="return_product_id"  id="product_id">
                                            <option value="" >Select Product Type</option>
                                            @foreach ($getassignlist as $ptype)
                                                 <option value="{{ $ptype['getproduct']['id'] }}">{{ $ptype['getproduct']['ext_product_name'] }}</option>
                                            @endforeach
                                        </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="return_total_amt" id="total_price" class="form-control total_price @error('return_total_amt') is-invalid @enderror" >
                                            </div>
