        ...
        <div class="col-12">
            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title ">
                       <a href="{{url('/')}}/admin/add-edit-categorytype"> <button type="button" class="btn btn-block btn-info btn-flat ">Create Product Type</button></a>
                    </h3>
                </div>
             </div>
          <!-- /.card -->
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="  table table-bordered table-hover dataTable dtr-inline"
                ...
                <!--<button style="margin-bottom: 10px" class="btn btn-primary delete_all" data-url="{{ url('admin/categorytypeDeleteAll') }}">Delete All Selected</button>-->
                <thead>
                <tr>
                          ...
                          <div style="display:inline-flex;">
                            ...
                            @if ($type['status'] == '1')
                                 <form method="post" id="inactive_form_{{ $type['id'] }}"
                                     action="{{ url('/') }}/admin/Change-categorytype-status">
                                     {{ csrf_field() }}
                            ...
                            <td>
                              <div style="display:inline-flex;">
                                ...
                                <a title="Edit type Details" href="{{ url('admin/add-edit-categorytype/'.$type['id'] ) }}"><i style="font-size:25px;" class="fa fa-edit"></i></a>
                                <form method="post" id="delete_form_{{ $type['id'] }}"
                                action="{{ url('/') }}/admin/Delete-categorytype/{{ $type['id'] }}">
                                {{ csrf_field() }}
